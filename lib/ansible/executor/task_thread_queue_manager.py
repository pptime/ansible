...
from ansible.plugins.loader import callback_loader, thread_strategy_loader, module_loader
...
__all__ = ['TaskThreadQueueManager']


class TaskThreadQueueManager:
    ...
    def __init__(self, inventory, variable_manager, loader, options, passwords, stdout_callback=None, run_additional_callbacks=True, run_tree=False):
        ...
        self._final_q = multiprocessing.dummy.Queue()
    ...
    def _initialize_processes(self, num):
        ...
        for i in range(num):
            rslt_q = multiprocessing.dummy.Queue()
    ...
    def run(self, play):
        ...
        strategy = thread_strategy_loader.get(new_play.strategy, self)
        if strategy is None:
